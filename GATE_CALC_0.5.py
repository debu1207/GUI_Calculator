...
win.iconbitmap("D:\Python Projects\Project_2_GUI\Graphicloads-100-Flat-2-Calculator.ico")
win.geometry("300x324")  # this is for the size of the window
...
btns_frame = Frame(win, width=280, height=230, bg="grey")

btns_frame.pack()

# first row

clear = Button(btns_frame, text="C", fg="black", width=32, height=3, bd=0, bg="#FA5931", cursor="hand2",
               command=lambda: bt_clear()).grid(row=0, column=0, columnspan=3, padx=1, pady=1)

divide = Button(btns_frame, text="/", fg="black", width=10, height=3, bd=0, bg="#D4D2D2", cursor="hand2",
...
multiply = Button(btns_frame, text="*", fg="black", width=10, height=3, bd=0, bg="#D4D2D2", cursor="hand2",
...
minus = Button(btns_frame, text="-", fg="black", width=10, height=3, bd=0, bg="#D4D2D2", cursor="hand2",
...
plus = Button(btns_frame, text="+", fg="black", width=10, height=3, bd=0, bg="#D4D2D2", cursor="hand2",
...
equals = Button(btns_frame, text="=", fg="black", width=10, height=3, bd=0, bg="#5EEF54", cursor="hand2",
